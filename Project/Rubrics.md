...
> ^Remarks: A feature is said to be implemented only if the implementation is completed. That is, it can be demonstrated with a particular set of test cases. For example, only working a subsystem of a feature cannot be considered as _implemented_. 
------
